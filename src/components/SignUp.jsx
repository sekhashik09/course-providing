...
const handleSignUp =(event ) => {
    ...
    // // your code for sign up goes here
    // //...
	...
	<div class="relative py-3 sm:max-w-xl sm:mx-auto">
		...
		<div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
			<div class="max-w-md mx-auto">
				<div>
					<h1 class="text-2xl font-semibold">SignUp with Our Community</h1>
				</div>
				<div class="divide-y divide-gray-200">
					<form onSubmit= {handleSignUp} class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
						...
						<div class="relative">
							<button class="bg-blue-500 text-white rounded-md px-2  justify-center">SignUp</button>
						</div>
					</form>
				</div>
			</div>
